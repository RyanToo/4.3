<?php
	...
	echo 'Данный пользователь не авторизован!';
	die;
	}
	if (!empty($_GET) && (count($_GET) === 2)) {
		...
		} elseif ($_GET['action'] === 'done_1') {
			$objN = new DoAsExecutor($_GET['id'], $db);
			$objN->makeDone();
		} elseif ($_GET['action'] === 'delete_1') {
...
<body>
	...
	<?php
	if (isAuthorized()){
		print '<a href="logo1.php" style="display: inline-block; font-size: 20px; color: red; margin-top: 20px;">Выход</a>';
	}
	?>
</body>
</html>
